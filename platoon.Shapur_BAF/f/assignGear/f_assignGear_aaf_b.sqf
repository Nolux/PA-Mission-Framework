...
case "m":
{
	...
	if (f_param_backpacks <= 1) then {
		...
		(unitBackpack _unit) addItemCargoGlobal [_defib,1];
		...
		(unitBackpack _unit) addItemCargoGlobal [_med1,10];
	...
	if (f_param_backpacks == 2) then {
		...
		clearMagazineCargoGlobal (unitBackpack _unit);
		(unitBackpack _unit) addItemCargoGlobal [_defib,1];
		(unitBackpack _unit) addItemCargoGlobal [_bandage,25];
		(unitBackpack _unit) addItemCargoGlobal [_morphine,20];
		(unitBackpack _unit) addItemCargoGlobal [_epi,10];
		(unitBackpack _unit) addItemCargoGlobal [_blood,10];
		(unitBackpack _unit) addItemCargoGlobal [_med1,15];
