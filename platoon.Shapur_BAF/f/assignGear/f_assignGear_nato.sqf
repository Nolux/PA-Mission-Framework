...
_scope3 = "optic_Hamr";			// HAMR RCO scope = 1x - 10x
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		{_unit addItem _bandaid} forEach [1,2,3,4,6,7,8];
...
// CARGO: AMBULANCE - room for 50 weapons and 200 cargo items
	case "v_amb":
	{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		_unit addItemCargoGlobal [_bandage, 120];
		_unit addItemCargoGlobal [_med1, 120];
		_unit addItemCargoGlobal [_med2, 80];
		_unit addItemCargoGlobal [_med3, 40];
		_unit addItemCargoGlobal [_med4, 20];
		_unit addItemCargoGlobal [_med5, 10];
		_unit addItemCargoGlobal [_defib, 10];
		_unit addItemCargoGlobal [_epi,120];
		_unit addItemCargoGlobal [_morphine,120];
		_unit addItemCargoGlobal [_tourniquet, 10];
		_unit addItemCargoGlobal [_blood, 120];
		_unit addItemCargoGlobal [_earplug, 200];
	};

// CARGO: REPAIR - room for 10 weapons and 100 cargo items
	case "v_rep":
	{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		_unit addWeaponCargoGlobal [_toolkit, 10];
		_unit addMagazineCargoGlobal [_riflemag, 20];
		_unit addMagazineCargoGlobal [_glriflemag, 20];
		_unit addMagazineCargoGlobal [_carbinemag, 20];
		_unit addMagazineCargoGlobal [_armag, 8];
		...
		_unit addMagazineCargoGlobal [_glmag, 8];
		_unit addMagazineCargoGlobal [_glsmokewhite, 4];
		_unit addItemCargoGlobal [_earplug, 5];
	};

// CARGO: RADIO - room for 10 weapons and 100 cargo items
	case "v_rad":
	{
		clearWeaponCargoGlobal _unit;
		clearMagazineCargoGlobal _unit;
		_unit addItemCargoGlobal [_rifleRadio,50];
		_unit addItemCargoGlobal [_shortRadio,50];
		_unit addBackpackCargoGlobal [_longRadio,10];
	};
